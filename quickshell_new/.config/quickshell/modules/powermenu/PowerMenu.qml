            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        Layout.alignment: Qt.AlignHCenter
                        Layout.topMargin: 10
                        visible: root.packageManagerRunning || root.downloadRunning
                        color: Colors.md3.error
                        font.weight: Font.Bold
                        font.pixelSize: Appearance.font.size.large
                        text: "WARNING: Background " + (root.packageManagerRunning ? "updates" : "downloads") + " are currently running!"
                    }
                }
                GridLayout {
                    columns: 4

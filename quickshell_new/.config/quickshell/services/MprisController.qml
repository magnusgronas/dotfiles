...
Singleton {
    ...
    function cycleLoopState() {
        ...
        case MprisLoopState.None:
            this.setLoopState(MprisLoopState.Playlist);
            break;
        case MprisLoopState.Playlist:
            this.setLoopState(MprisLoopState.Track);
            break;
        case MprisLoopState.Track:
        default:
            this.setLoopState(MprisLoopState.None);
            break;
        }
    }
    ...
    function seekTo(position) {
        if (this.activePlayer && this.activePlayer.canSeek) {
            // Quickshell's MprisPlayer allows you to set the position directly

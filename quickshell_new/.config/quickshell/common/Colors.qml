...
Singleton {
    ...
    component Md3: JsonObject {
        ...
        // Custom matugen colors
        property string yellow: "transparent"
        property string yellow_container: "transparent"
        property string yellow_source: "transparent"
        property string yellow_value: "transparent"
        property string on_yellow: "transparent"
        property string on_yellow_container: "transparent"

        property string green: "transparent"
        property string green_container: "transparent"
        property string green_source: "transparent"
        property string green_value: "transparent"
        property string on_green: "transparent"
        property string on_green_container: "transparent"
